...
<body>
<header>
    <a href="<?php echo e(route('home')); ?>" aria-label="Beranda BPS Provinsi Sulawesi Selatan">
    ...
    <nav aria-label="Navigasi utama">
        ...
        <a class="<?php echo e(request()->routeIs('publikasi.create') ? 'active' : ''); ?>" href="<?php echo e(route('publikasi.create')); ?>">Tambah Publikasi</a>
...
<?php /**PATH C:\xampp\htdocs\webbps_laravel_bps_p\resources\views/layouts/app.blade.php ENDPATH**/ ?>